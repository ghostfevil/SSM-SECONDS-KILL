...
public class IndexController {
    ...
    @Autowired
    private StockServiceFacade stockService;
     ...
     * @return
     */
    @SpringControllerLimit(errorCode = 6000,errorMsg = "限流 add redis")
     ...
     * @return
     */
    @SpringControllerLimit(errorCode = 8000,errorMsg = "限流 add kafka异步")
